...
// Source: ./webook/pkg/limiter/rate_limiter.go
//
// Generated by this command:
//
//	mockgen.exe -source=./webook/pkg/limiter/rate_limiter.go -package=limitermocks -destination=./webook/pkg/limiter/mocks/rate_limiter.mock.go
//
